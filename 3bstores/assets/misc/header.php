...
if(window.location.href.indexOf("3bstores.in/3bstores")>=0) {
    var BASE_URL = "http://www.3bstores.in/3bstores/v1/api/";
    var BASE_IMAGE_URL = "http://3bstores.in/3bstores/v1/storage/app/";
