...
<div class="card">
  <div class="card-body" style="padding:0;padding-top: 1.25rem;padding-left: 1rem;padding-right: 1rem;">
      ...
      <div class="row">
        <div class="col-3">
          <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
            <a class="nav-link" style="border-bottom: 1px solid #d2d2d2;" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-credit" role="tab" aria-controls="v-pills-home" aria-selected="true">Credit / Debit Card</a>
            <a class="nav-link" style="border-bottom: 1px solid #d2d2d2;"id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-nbanking" role="tab" aria-controls="v-pills-profile" aria-selected="false">Net Banking</a>
            <a class="nav-link active" style="border-bottom: 1px solid #d2d2d2;" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-cod" role="tab" aria-controls="v-pills-profile" aria-selected="false">Cash On Delivery</a>
        ...
        <div class="col-9">
          <div class="tab-content" id="v-pills-tabContent">
            <div class="tab-pane fade" id="v-pills-credit" role="tabpanel" aria-labelledby="v-pills-home-tab">...</div>
    ...
    <div class="row" style="padding: 0% 3% 2% 3%;">
      ...
      <div class="col-md-4" style="text-align: right;">
        <div onclick="placeOrder()" class="btn btn-primary" tabindex="0" style="margin:auto;width:60%;background: #ff8f03 !important;border: 1px solid #ff8f03;color:#201e1e">Place Order</div>
      </div>
    </div>
  </div>
</div>
